  ...
  <body id="page-top">
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Dipayan
            <span class="text-primary">Das</span>
          </h1>
          <div class="subheading mb-5">Roy para Raja Road Krishnanagar Nadia 741101
            <a href="mailto:name@email.com">picku.pickudas@gmail.com</a>
          </div>
